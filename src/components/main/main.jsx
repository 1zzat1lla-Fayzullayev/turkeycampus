    ...
    <>
      <div className="main-gradient overflow-x-hidden">
        <Wrapper>
            ...
            {mainData.map((item, index) => (
              <SwiperSlide key={index}>
                <div className="flex flex-col md:flex-row mx-[20px] xl:mx-0 justify-around  items-center mt-[20px]">
                  <div className="flex justify-center items-center text-center md:text-start md:items-start md:justify-start flex-col gap-[10px]">
          ...
          <div className="overflow-x-hidden object-cover">
            <MainLine />
          </div>
        </Wrapper>
      </div>
